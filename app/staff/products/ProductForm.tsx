  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        {trigger || (
          <Button className="bg-blue-500 hover:bg-blue-600 text-white font-bold px-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 pt-4">
          ...
          <div className="space-y-2">
            ...
            <textarea 
              ...
              className="w-full bg-zinc-950 border border-zinc-800 rounded-lg py-2.5 px-4 text-white focus:outline-none focus:border-blue-400/50 transition-all resize-none"
            />
          </div>
          ...
          <DialogFooter className="pt-6 border-t border-zinc-800">
            ...
            <Button 
              type="submit" 
              disabled={loading}
              className="bg-blue-500 hover:bg-blue-600 text-white font-bold px-8 shadow-[0_0_20px_rgba(96,165,250,0.2)]"
            >
              {loading ? <Loader2 size={18} className="animate-spin mr-2" /> : (product ? 'Update Product' : 'Save & Publish')}
            </Button>
          </DialogFooter>
        </form>
      </DialogContent>
