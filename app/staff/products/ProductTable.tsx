        ...
        {filteredProducts.map((product) => (
          ...
          >
            ...
            <div className="relative aspect-[4/3] bg-zinc-950 overflow-hidden">
              ...
              />
              <div className="absolute top-4 right-4 flex flex-col gap-2 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-all duration-300 translate-x-0 md:translate-x-2 md:group-hover:translate-x-0">
                <ProductForm 
