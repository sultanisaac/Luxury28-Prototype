    ...
    <div className="min-h-screen bg-zinc-950 flex text-white font-sans">
      ...
      <aside className="w-64 flex-shrink-0 bg-zinc-900 border-r border-zinc-800 flex flex-col hidden md:flex">
        <div className="h-16 flex items-center px-6 border-b border-zinc-800">
          <Link href="/staff" className="font-serif text-xl tracking-widest font-bold">LUXURY28 <span className="text-blue-400 text-xs tracking-normal ml-1">STAFF</span></Link>
        </div>
      ...
      <main className="flex-1 flex flex-col min-h-screen overflow-hidden">
        ...
        <header className="h-16 md:hidden border-b border-zinc-800 bg-zinc-900 flex items-center justify-between px-4">
          <Link href="/staff" className="font-serif text-lg tracking-widest font-bold">LUXURY28 <span className="text-blue-400 text-[10px] tracking-normal ml-1">STAFF</span></Link>
          <form action={logout}>
